About flask-migrate-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flask-migrate-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=313&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flask-migrate-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flask-migrate` can be installed with `conda`:
...
```
mamba install flask-migrate
```

It is possible to list all of the versions of `flask-migrate` available on your platform with `conda`:
...
```
mamba search flask-migrate --channel conda-forge
```
...
mamba repoquery search flask-migrate --channel conda-forge

# List packages depending on `flask-migrate`:
mamba repoquery whoneeds flask-migrate --channel conda-forge

# List dependencies of `flask-migrate`:
mamba repoquery depends flask-migrate --channel conda-forge
```
